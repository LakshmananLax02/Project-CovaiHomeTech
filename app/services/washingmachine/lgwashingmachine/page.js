...
export const metadata = {
  title: "LG Washing Machine Repair Service in Coimbatore | Covai Home Tech",
  description: "Expert LG washing machine repair service in Coimbatore for front load, top load, and fully automatic models. Fast doorstep support and affordable service.",
};
...
export default function lgwashingmachine(){
    return(
         <>
      ...
      <div className="bg-[#002D62] pt-10 pb-12   shadow-2xl relative overflow-hidden">
        <div className="max-w-5xl mx-auto px-4 relative z-10">
          ...
          <div className="mt-16 w-full">
            <div className="relative aspect-[10/11] rounded-[1rem] overflow-hidden border-4 border-white/10 shadow-2xl group">
              <img 
                src="/washingmachine/LG.jpg" 
...
, we provide professional LG washing machine repair 
            ...
            <article className="bg-slate-50 p-8 md:p-12 rounded-[7px] border border-slate-100 shadow-sm">
              ...
              <p className="text-slate-600 leading-relaxed text-lg mb-8">
                Our expert team offers reliable repair and maintenance services for all LG 
            ...
            <div className="pt-8 border-t border-slate-100">
               ...
               <p className="text-slate-600 text-lg">
                We provide LG washing machine repair services across Coimbatore and nearby areas.
               </p>
            </div>
          </div>
            ...
            <div className="bg-[#002D62] text-white p-10 rounded-[1rem] shadow-2xl sticky top-24">
              ...
              <div className="mt-12 pt-8 border-t border-white/10 text-center">
                <p className="text-sm text-blue-200 mb-8 font-medium italic">
                  Need fast and reliable LG washing machine service in Coimbatore?
                </p>
