...
export const metadata = {
  title: "Onida Washing Machine Repair in Coimbatore",
  description: "Reliable Onida washing machine repair services with fast support across Coimbatore.",
};
...
export default function onidawashingmachine(){
    return(
         <>
 ...
 <div className="relative aspect-[10/11] rounded-[1rem] overflow-hidden border-4 border-white/10 shadow-2xl group">              <img 
                src="/washingmachine/Onida.jpg" 
                alt="Professional Onida Washing Machine Repair Service" 
  ...
  <span className="font-black italic text-xl">Onida</span>
          ...
          <div className="md:col-span-2 space-y-16">
            ...
            <article>
              ...
              <p className="text-slate-600 leading-relaxed text-lg">
                At Covai Home Tech
, we provide professional Onida washing machine repair 
                services in Coimbatore with fast doorstep support. Our experienced technicians 
                are trained to handle all Onida washing machine models, including top load, 
            ...
            <article className="bg-slate-50 p-8 md:p-12 rounded-[7px] border border-slate-100 shadow-sm">
              ...
              <p className="text-slate-600 leading-relaxed text-lg mb-8">
                Our expert team offers reliable repair and maintenance services for all Onida 
            ...
            <div className="pt-8 border-t border-slate-100">
               ...
               <p className="text-slate-600 text-lg">
                We provide Onida washing machine repair services across Coimbatore and nearby areas.
               </p>
            </div>
          </div>
            ...
            <div className="bg-[#002D62] text-white p-10 rounded-[1rem] shadow-2xl sticky top-24">
              ...
              <div className="mt-12 pt-8 border-t border-white/10 text-center">
                <p className="text-sm text-blue-200 mb-8 font-medium italic">
                  Need fast and reliable Onida washing machine service in Coimbatore?
                </p>
