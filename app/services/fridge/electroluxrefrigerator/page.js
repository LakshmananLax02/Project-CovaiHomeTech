...
export const metadata = {
  title: "Electrolux Refrigerator Service in Coimbatore | Covai Home Tech",
  description: "Expert Electrolux refrigerator repair and maintenance service in Coimbatore.",
};
...
export default function electroluxrefrigerator(){
    return(
        <>
 ...
 <div className="relative aspect-[10/11] rounded-[1rem] overflow-hidden border-4 border-white/10 shadow-2xl group">              <img 
                src="/fridgeimages/electroluxfridge.jpg" 
                alt="Professional Electrolux Refrigerator Repair Service" 
  ...
  <span className="font-black italic text-xl">Electrolux</span>
          ...
          <div className="md:col-span-2 space-y-16">
            ...
            <article>
              ...
              <p className="text-slate-600 leading-relaxed text-lg">
                At Covai Home Tech, we provide professional Electrolux refrigerator repair services in Coimbatore with fast doorstep support. Our experienced technicians are trained to handle all Electrolux refrigerator models.
We ensure quick diagnosis, affordable service charges, and genuine spare parts for long-lasting cooling performance.
            ...
            <article className="bg-slate-50 p-8 md:p-12 rounded-[7px] border border-slate-100 shadow-sm">
              ...
              <p className="text-slate-600 leading-relaxed text-lg mb-8">
                 Our expert team offers reliable repair and maintenance services for all Electrolux refrigerator issues. Whether it is a minor fault or major repair, we provide 
            ...
            <div className="pt-8 border-t border-slate-100">
               ...
               <p className="text-slate-600 text-lg">
                We provide Electrolux Refrigerator repair services across Coimbatore and nearby areas.
               </p>
            </div>
          </div>
            ...
            <div className="bg-[#002D62] text-white p-10 rounded-[1rem] shadow-2xl sticky top-24">
              ...
              <div className="mt-12 pt-8 border-t border-white/10 text-center">
                <p className="text-sm text-blue-200 mb-8 font-medium italic">
                  Need fast and reliable Electrolux Refrigerator service in Coimbatore?
                </p>
