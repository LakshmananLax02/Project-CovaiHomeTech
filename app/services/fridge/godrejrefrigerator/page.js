...
export const metadata = {
  title: "Godrej Refrigerator Repair in Coimbatore | Covai Home Tech",
  description: "Expert Godrej fridge repair service in Coimbatore for cooling, freezer, and compressor issues.",
};
...
export default function godrejrefrigerator(){
    return(
         <>
 ...
 <div className="relative aspect-[10/11] rounded-[1rem] overflow-hidden border-4 border-white/10 shadow-2xl group">              <img 
                src="/fridgeimages/godrejfridge.jpg" 
                alt="Professional Godrej Refrigerator Repair Service" 
  ...
  <span className="font-black italic text-xl">Godrej</span>
          ...
          <div className="md:col-span-2 space-y-16">
            ...
            <article>
              ...
              <p className="text-slate-600 leading-relaxed text-lg">
                At Covai Home Tech, we provide professional Godrej refrigerator repair services in Coimbatore with fast doorstep support. Our experienced technicians are trained to handle all Godrej refrigerator models.
We ensure quick diagnosis, affordable service charges, and genuine spare parts for long-lasting cooling performance.
            ...
            <article className="bg-slate-50 p-8 md:p-12 rounded-[7px] border border-slate-100 shadow-sm">
              ...
              <p className="text-slate-600 leading-relaxed text-lg mb-8">
                 Our expert team offers reliable repair and maintenance services for all Godrej refrigerator issues. Whether it is a minor fault or major repair, we provide 
            ...
            <div className="pt-8 border-t border-slate-100">
               ...
               <p className="text-slate-600 text-lg">
                We provide Godrej Refrigerator repair services across Coimbatore and nearby areas.
               </p>
            </div>
          </div>
