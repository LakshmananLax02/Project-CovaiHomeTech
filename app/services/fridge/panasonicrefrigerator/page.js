...
export const metadata = {
  title: "Panasonic Refrigerator Repair in Coimbatore | Covai Home Tech",
  description: "Affordable Panasonic refrigerator service in Coimbatore for cooling and gas leakage issues.",
};
...
export default function panasonicrefrigerator(){
    return(
        <>
 ...
 <div className="relative aspect-[10/11] rounded-[1rem] overflow-hidden border-4 border-white/10 shadow-2xl group">              <img 
                src="/fridgeimages/panasonicfridge.jpg" 
                alt="Professional Panasonic Refrigerator Repair Service" 
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" 
              />
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/60 to-transparent"></div>
              
              <div className="absolute bottom-6 left-6 md:bottom-10 md:left-10">
   <div className="bg-[#FF5C00] text-white px-6 py-2 rounded-xl shadow-xl flex items-center justify-between mb-3 w-full max-w-sm">
  {/* Text stays on the far left */}
  <span className="font-black italic text-xl">Panasonic</span>
          ...
          <div className="md:col-span-2 space-y-16">
            ...
            <article>
              ...
              <p className="text-slate-600 leading-relaxed text-lg">
                At Covai Home Tech, we provide professional Panasonic refrigerator repair services in Coimbatore with fast doorstep support. Our experienced technicians are trained to handle all Panasonic refrigerator models.
We ensure quick diagnosis, affordable service charges, and genuine spare parts for long-lasting cooling performance.
            ...
            {/* About Our Service */}
            <article className="bg-slate-50 p-8 md:p-12 rounded-[7px] border border-slate-100 shadow-sm">

              <h2 className="text-3xl font-black text-slate-900 mb-6">About Our Service</h2>
              <p className="text-slate-600 leading-relaxed text-lg mb-8">
                 Our expert team offers reliable repair and maintenance services for all Panasonic refrigerator issues. Whether it is a minor fault or major repair, we provide 
            ...
            <div className="pt-8 border-t border-slate-100">
               ...
               <p className="text-slate-600 text-lg">
                We provide Panasonic Refrigerator repair services across Coimbatore and nearby areas.
               </p>
            </div>
          </div>
            ...
            <div className="bg-[#002D62] text-white p-10 rounded-[1rem] shadow-2xl sticky top-24">
              ...
              <div className="mt-12 pt-8 border-t border-white/10 text-center">
                <p className="text-sm text-blue-200 mb-8 font-medium italic">
                  Need fast and reliable Panasonic Refrigerator service in Coimbatore?
                </p>
                 <Link href="/contact-us"> <button className="w-full bg-[#FF5C00] hover:bg-orange-500 text-white font-black py-5 rounded-xl transition-all shadow-xl active:scale-95 text-lg">
