...
export const metadata = {
  title: "Lloyd AC Repair Service in Coimbatore",
  description: "Affordable Lloyd AC repair and maintenance service.",
};
...
We ensure quick diagnosis, affordable service charges, and genuine spare parts.
 ...
 Book your service today with Covai Home Tech for expert technician support.
    ...
    <DisclaimerSection/><div className="bg-white min-h-screen">
      {/* 1. HEADER SECTION (Dark Slate) */}
      <div className="bg-[#002D62] pt-10 pb-12   shadow-2xl relative overflow-hidden">
        <div className="max-w-5xl mx-auto px-4 relative z-10">
          <div className="text-center mb-8">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="md:col-span-2 space-y-16">
            ...
            <article>
              ...
              <p className="text-slate-600 leading-relaxed text-lg">
               At Covai Home Tech, we provide professional Lloyd AC repair services in Coimbatore with fast doorstep support. Our experienced technicians are trained to handle all Lloyd air conditioner models, including split AC, window AC, inverter AC, and smart AC units.
We ensure quick diagnosis, affordable service charges, and genuine spare parts for long-lasting cooling performance.
            ...
            <article className="bg-slate-50 p-8 md:p-12 rounded-[7px] border border-slate-100 shadow-sm">
              ...
              <h2 className="text-3xl font-black text-slate-900 mb-6">About Our Service</h2>
              <p className="text-slate-600 leading-relaxed text-lg mb-8">
                Our expert team offers reliable repair and maintenance services for all Lloyd AC issues. Whether it is a minor cooling fault or major repair, we provide fast solutions with quality service.
              </p>
            ...
            <div className="pt-8 border-t border-slate-100">
               <h2 className="text-2xl font-black text-slate-900 mb-4 tracking-tight">Service Areas</h2>
               <p className="text-slate-600 text-lg">
We provide Lloyd AC repair services across Coimbatore and nearby areas.               </p>
            </div>
          </div>
          ...
          <aside className="space-y-8">
            <div className="bg-[#002D62] text-white p-10 rounded-[1rem] shadow-2xl sticky top-24">
              ...
              <div className="mt-12 pt-8 border-t border-white/10 text-center">
                <p className="text-sm text-blue-200 mb-8 font-medium italic">
Need fast and reliable Lloyd AC service in Coimbatore?                </p>
                 <Link href="/contact-us"> <button className="w-full bg-[#FF5C00] hover:bg-orange-500 text-white font-black py-5 rounded-xl transition-all shadow-xl active:scale-95 text-lg">
