...
const steps = [
  {
    ...
    title: "Book Online",
    description: "Easily schedule your TV repair service at your preferred time."
  },
  {
    icon: <Calendar size={24} />,
    title: "Customize Plan",
    description: "Select your TV type, issue category, and preferred service slot."
  },
  {
    icon: <User size={24} />,
    title: "Meet Your Technician",
    description: "Experienced TV service professionals arrive on time with the required tools."
  },
  {
    icon: <CheckSquare size={24} />,
    title: "Get Perfect Results",
    description: "Complete testing for display, sound, and software performance."
  }
];
