 ...
 const steps = [
  {
    ...
    title: "Book Online",
    description: "Quick and easy service booking at your preferred time."
  },
  {
    icon: <Calendar size={24} />,
    title: "Customize Plan",
    description: "Choose refrigerator type, issue category, and preferred schedule."
  },
  {
    icon: <User size={24} />,
    title: "Meet Your Technician",
    description: "Experienced fridge repair technicians arrive on time with tools and genuine spare parts."
  },
  {
    icon: <CheckSquare size={24} />,
    title: "Get Cooling Results",
    description: "Complete cooling restoration with performance testing and warranty-backed service."
  }
];
